...
func TestSjsonBasic(t *testing.T) {
...
// TestSjsonRandomData is a fuzzing test that throws random data at SetRaw
// function looking for panics.
func TestSjsonRandomData(t *testing.T) {
	var lstr string
	defer func() {
		if v := recover(); v != nil {
...
func TestDeleteIssue21(t *testing.T) {
	...
	res1 := Get(json, "date_updated")
	var err error
	json, err = Delete(json, "date_updated")
	if err != nil {
		t.Fatal(err)
	}
	res2 := Get(json, "date_updated")
	res3 := Get(json, "date_created")
